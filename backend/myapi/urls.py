...
router.register(r'prospect-companies', ProspectCompanyViewSet)
...
urlpatterns = [
    ...
    path('stats/prospect-companies/', prospect_company_stats_view, name='prospect-company-stats'),
    ...
    path('export/prospect-companies/', download_prospect_companies_csv, name='download-prospect-companies-csv'),
